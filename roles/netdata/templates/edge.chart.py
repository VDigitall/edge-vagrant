...
ORDER = ['queues', 'workers', 'problem_docs', 'process_documents', 'exceptions']
CHARTS = {
    'process_documents': {
        'options': [None, 'Process documents', 'documents', 'Process documents',
                    '', 'line'],
        'lines': [
    ...
    'problem_docs': {
        'options': [None, 'Problem documents', 'documents', 'Problem documents',
                    '', 'line'],
        'lines': [
    ...
    'exceptions': {
        'options': [None, 'Exceptions', 'exceptions', 'Exceptions', '', 'line'],
        'lines': [
            ['exceptions_count', 'all exceptions', 'absolute', 1, 1]
        ]
    },
    'queues': {
        'options': [None, 'Queue', 'items', 'Queue fill', '', 'line'],
        'lines': [
